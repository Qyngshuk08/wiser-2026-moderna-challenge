...
Full chronological record of every run, bug found, and fix made during this
project — kept in full for reproducibility and rigor. For the summarized,
judge-facing version, see `README.md`.
